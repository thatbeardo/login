...
type Service interface {
	...
	CreateClient(context.Context, repository.Client) (repository.Client, error)
}
...
func (service *service) CreateClient(ctx context.Context, input repository.Client) (repository.Client, error) {
