...
// 	context "github.com//mocks/context"
// 	models "github.com//models"
// 	resource "github.com//models/resource/dto"
// 	"github.com//models/resource/repository"
...
// 		<-[:GRANTED_TO]-(:Context)-[:PERMISSION{name:":read"}]->
// 		(tenant:Resource{source_id: $tenant})<-[:GRANTED_TO]-(:Context)-[:PERMISSION{name:":read"}]->(hub:Resource)
...
// 		-[:PERMISSION{name:":read", permitted: "allow"}]->
// 		(tenant:Resource{source_id: $tenant})<-[:GRANTED_TO]-(:Context)
// 		-[:PERMISSION{name:":read", permitted: "allow"}]->(hub:Resource)
// 		RETURN {child: hub}`
